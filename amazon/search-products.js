 ...
 *             使用者需遵守 Amazon 服务条款,不得用于反爬/转售/商业化替代。
...
/* @meta
{
  ...
  "args": {
    "keyword": {
      "required": true,
      "description": "搜索关键词，如 'laptop'、'headphones'、'kindle'"
    },
    "department": {
      "required": false,
      "description": "商品分类搜索别名，如 electronics（电子产品）、books（图书）、appliances（家电）、tools（工具）、sports（运动）、clothing（服装）"
    }
  },
