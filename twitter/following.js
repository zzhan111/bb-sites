...
async function(args) {
  ...
  const queryId = findGraphQLQueryId('HomeLatestTimeline', 'DiTkXJgLqBBxCs7zaYsbtA');
  const url = '/i/api/graphql/' + queryId + '/HomeLatestTimeline?variables=' + encodeURIComponent(variables) + '&features=' + encodeURIComponent(features);
